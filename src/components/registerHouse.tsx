...
export const formSchema = z.object({
  ...
  complement: z.string().min(2).max(50),
  city: z.string().min(2).max(50),
  state: z.string().min(2).max(50),
  zipCode: z.string().min(2).max(50),
  type: z.string().min(2).max(50),
  totalArea: z.string().min(2).max(50),
  usefulArea: z.string().min(2).max(50),
  rooms: z.string().min(2).max(50),
  bathrooms: z.string().min(2).max(50),
  parkingSpaces: z.string().min(2).max(50),
  rentValue: z.string().min(2).max(50),
  condoValue: z.string().min(2).max(50),
      ...
      <DialogContent className="p-6 bg-white rounded-lg shadow-xl font-primary w-[70%]">
        ...
        <form>
         ...
         <div className="grid grid-cols-3 gap-2">
          ...
          <CustomInput label="Endereço" type="text" formName="name" form={form} control={form.control} />
          <CustomInput label="Complemento" type="text" formName="name" form={form} control={form.control} />
          <CustomRequestSelect 
            label="Estado" 
            formName="state" 
            form={form} 
          ...
          />
          <CustomInput label="CEP" type="text" formName="name" form={form} control={form.control} />
          <Label className="col-span-3 mt-3.5">Especificações</Label>
          <hr className="col-span-3 border-t mb-3 border-gray-300" />
          <CustomSelect label="Tipo" formName="tipo" form={form} 
            options={[
          ...
          />
          <CustomInput label="Área Total" type="text" formName="name" form={form} control={form.control} />
          <CustomInput label="Área Útil" type="text" formName="name" form={form} control={form.control} />
          <CustomInput label="Quartos" type="text" formName="name" form={form} control={form.control} />
          <CustomInput label="Banheiros" type="text" formName="name" form={form} control={form.control} />
          <CustomInput label="Vagas de Garagem" type="text" formName="name" form={form} control={form.control} />
          <CustomInput label="Valor do Aluguel" type="text" formName="name" form={form} control={form.control} />
          <CustomInput label="Valor do Condomínio" type="text" formName="name" form={form} control={form.control} />
          <CustomInput label="Status" type="text" formName="name" form={form} control={form.control} />
          <CustomInput label="Descrição" type="text" formName="name" form={form} control={form.control} />
         </div>
